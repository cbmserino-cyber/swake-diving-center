export default function SwakeWebsite() {
  const reviews = [
    {
      quote:
        'Felt really safe and comfortable the whole time. Went deeper than I expected.',
    },
    {
      quote:
        'First time freediving and it was an amazing experience. Professional and supportive.',
    },
    {
      quote:
        'Clear guidance, very patient instructors, and a great experience overall.',
    },
  ];
